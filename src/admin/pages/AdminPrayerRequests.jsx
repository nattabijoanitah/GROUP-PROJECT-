  ...
  const loadRequests = async () => {
    try {
      ...
      const response = await fetch(
       `${API_BASE_URL}/api/admin/prayer-requests`,
        {
          headers: {
      ...
      if (!response.ok) {
        throw new Error(
          data.message ||
            data.error ||
            `Failed to load prayer requests (${response.status})`
        );
      }
