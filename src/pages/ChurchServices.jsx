...
import { Clock, Calendar, MapPin, Laptop, Users } from 'lucide-react';
...
const services = [
  ...
  },
  {
    ...
    type: 'Main Service',
    description:
      'A safe, fun, and Christ-centered gathering for children held alongside the main Sunday services, with bible lessons, songs, and activities.'
  },
  {
    name: 'Main Service',
  ...
  },
  {
    ...
    day: 'Every Tuesday',
    location: 'Main Sanctuary & WhatsApp (Online)',
    type: 'Bible Study',
    description:
  ...
  },
  {
    ...
    day: 'Every Sunday',
    location: 'YouTube & Church Website',
    type: 'Online',
    description:
      'Can\'t make it in person? Join our global livestream on YouTube. Thousands from around the world worship together in real-time.'
  }
];
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                  ...
                  <span style={{ color: 'var(--text-dark-muted)', fontSize: '0.9rem' }}>
                    <strong>WhatsApp:</strong> +0705 109 975 (Bible study broadcast on service days)
                  </span>
                </div>
              </div>
            </div>
