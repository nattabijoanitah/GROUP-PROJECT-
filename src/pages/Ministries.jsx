...
import { Flame, Music, Sparkles, Baby, HeartHandshake, Shield, Heart, Compass, BookOpen, Clock, User, Check } from 'lucide-react';
      ...
      <section className="light-section section-padding" style={{ borderTop: '1px solid #e5e7eb', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
            <a href="/join" className="btn btn-primary">Join a Ministry</a>
