...
import { CreditCard, ShieldCheck, Heart, Landmark, Check } from 'lucide-react';
            ...
            <div className="glass-card" style={{ padding: '2.5rem' }}>
              {submitted ? (
                ...
                <form onSubmit={handleGiveSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                  ...
                  {/* Category selector */}
                  <div>
                    <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: 'var(--accent-gold)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Where Would You Like to Give?</label>
                  ...
                  {/* Preset Amount Grid */}
                  <div>
                    <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 600, color: 'var(--accent-gold)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Select Amount (UGX)</label>
                  ...
                  <button type="submit" className="btn btn-primary" style={{ width: '100%', padding: '0.85rem' }}>
                    Sow Seed of UGX {Number(amount === 'custom' ? (customAmount || 0) : amount).toLocaleString()}
                  </button>
