        ...
        <div className="container" style={{ maxWidth: '800px', display: 'flex', gap: '1.5rem', alignItems: 'flex-start', backgroundColor: '#f0ede4', padding: '2rem', borderRadius: '8px' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-dark-muted)', fontSize: '0.95rem', margin: 0 }}>
              All our conferences and main services are broadcasted live on our YouTube channel and Facebook Page. If you are unable to join us in-person due to distance, check our media tabs on service days to join the online streams.
            </p>
          </div>
        </div>
      </section>
